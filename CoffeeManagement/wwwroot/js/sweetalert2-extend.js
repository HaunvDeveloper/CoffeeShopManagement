...
function showAlertRedirect(icon, title, text = "", url = "", showConfirmButton = false, showCancelButton = false, timer = 1500) {
    Swal.fire({
        icon: icon,
        title: title,
        text: text,
...
function loadingAction(title = "Đang xử lý...", text = "Vui lòng chờ giây lát", allowOutsideClick = false) {
    Swal.fire({
        title: title,
        text: text,
